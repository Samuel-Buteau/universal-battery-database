...
class Migration(
    ...
    dependencies = [('filename_database', '0001_initial')]
        ...
        migrations.CreateModel(
            ...
            fields = [
                (
                    ...
                    'chg_average_current_by_capacity', models.FloatField(
                        null = True,
                    ),
                ), (
                    'chg_average_current_by_voltage', models.FloatField(
                        null = True,
                    ),
                ), (
                    ...
                    'dchg_average_current_by_capacity', models.FloatField(
                        null = True,
                    ),
                ), (
                    'dchg_average_current_by_voltage', models.FloatField(
                        null = True,
                    ),
                ), (
        ...
        migrations.CreateModel(
            ...
            fields = [
                (
                    ...
                    'average_current_by_capacity', models.FloatField(
                        null = True,
                    ),
                ), (
                    'average_current_by_voltage', models.FloatField(
                        null = True,
                    ),
                ), (
            ...
            fields = [
                (
                    ...
                    'database_file', models.OneToOneField(
                        on_delete = django.db.models.deletion.CASCADE,
                        to = 'filename_database.DatabaseFile',
                    )
                ),
            ],
