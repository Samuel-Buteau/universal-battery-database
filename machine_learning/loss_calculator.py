...
def calculate_reciprocal_loss(
    sampled_vs, sampled_qs, v_plus, v_minus, v_plus_der, v_minus_der,
    reciprocal_v, reciprocal_q, incentive_coeffs
):
    return incentive_combine([
        (
            ...
            incentive_magnitude(v_minus, Target.Small, Level.Proportional),
        ), (
            incentive_coeffs["coeff_reciprocal_v_small"],
            incentive_magnitude(v_plus, Target.Small, Level.Proportional),
        ), (
            ...
            incentive_coeffs["coeff_reciprocal_v_leq"],
            incentive_inequality(v_plus, Inequality.LessThan, 5., Level.Strong),
        ), (
            incentive_coeffs["coeff_reciprocal_v_mono"],
            incentive_inequality(
...
def calculate_q_loss(q, q_der, incentive_coeffs):
    return incentive_combine([
        (
            ...
            incentive_magnitude(q, Target.Small, Level.Proportional),
        ), (
...
def calculate_scale_loss(scale, scale_der, incentive_coeffs):
    return incentive_combine([
        (
            ...
            incentive_inequality(scale, Inequality.LessThan, 1., Level.Strong),
        ), (
...
def calculate_shift_loss(shift, shift_der, incentive_coeffs):
    return incentive_combine([
        (
            ...
            incentive_inequality(shift, Inequality.LessThan, 0.5, Level.Strong),
        ),
        # (
        ...
        (
            ...
            incentive_magnitude(shift, Target.Small, Level.Proportional),
        ), (
...
def calculate_r_loss(r, r_der, incentive_coeffs):
    return incentive_combine([
        (
            ...
            incentive_inequality(r, Inequality.GreaterThan, 0.01, Level.Strong),
        ), (
            incentive_coeffs["coeff_r_big"],
            incentive_magnitude(r, Target.Big, Level.Proportional),
        ), (
