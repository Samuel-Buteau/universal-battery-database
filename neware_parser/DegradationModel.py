...
class DegradationModel(Model):
    ...
    def z_cell_from_indecies(self, indecies, training = True, sample = False,
        ...
        fetched_molecule_weights = (tf.reshape(fetched_weights_electrolyte, [-1,
    ...
    def pos_projection_direct(self, cell_features, training = True):
        ...
        return nn_call(self.nn_pos_projection, dependencies,
                       training = training)
    ...
    def stress_to_strain_direct(self, norm_cycle, cell_features, encoded_stress,
                                training = True):
        dependencies = (
            norm_cycle,
            cell_features,
    ...
    def stress_to_encoded_direct(self, svit_grid, count_matrix,
                                 training = True):
    ...
    def reciprocal_Q(self, params, training = True):
        cell_features = self.cell_features_direct(features = params['features'],
                                                  training = training)
        V = self.V_direct(Q = params['Q'], shift = params['shift'],
    ...
    def cc_voltage(self, params, training = True):
        ...
        cc_voltage = voltage + self.add_volt_dep(
