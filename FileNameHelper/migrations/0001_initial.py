# Generated by Django 2.2.6 on 2019-10-11 16:52
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('student', models.CharField(default='', max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('all_possible_barcodes', models.ManyToManyField(related_name='all_possible_barcodes', to='FileNameHelper.Token')),
                ('all_possible_dates', models.ManyToManyField(related_name='all_possible_dates', to='FileNameHelper.Token')),
                ('all_possible_experiment_types', models.ManyToManyField(to='FileNameHelper.ExperimentType')),
                ('all_possible_start_cycles', models.ManyToManyField(related_name='all_possible_start_cycles', to='FileNameHelper.Token')),
                ('all_possible_students', models.ManyToManyField(related_name='all_possible_students', to='FileNameHelper.Token')),
                ('all_possible_temperatures', models.ManyToManyField(related_name='all_possible_temperatures', to='FileNameHelper.Token')),
                ('all_possible_voltages', models.ManyToManyField(related_name='all_possible_voltages', to='FileNameHelper.Token')),
