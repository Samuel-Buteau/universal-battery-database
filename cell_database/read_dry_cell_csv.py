def dry_cell_csv_to_db(file):
    ...
    import pandas as pd
    from cell_database.models import DryCell, AnodeBinder, CathodeBinder, Cathode, CathodeConductiveAdditive,AnodeConductiveAdditive, MechanicalPouch, BuildInfo, Box, OtherInfo,\
