class Key:
    ...
    FOUR_FEAT = "four_feat"
    T_Q_SIGMA = "t_q_sig"
    T_Q_SIGMA_CYC = "t_q_sig_cyc"
    T_Q_SIGMA_V = "t_q_sig_voltage"
    T_Q_SIGMA_I = "t_q_sig_current"
    S_Q_SIGMA = "s_q_sig"
    S_Q_SIGMA_CYC = "s_q_sig_cyc"
    S_Q_SIGMA_V = "s_q_sig_voltage"
    S_Q_SIGMA_I = "s_q_sig_current"
