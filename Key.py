class Key:
    ...
    V = "v"
    V_CC = "cc_voltages"
    V_CC_TENSOR = "cc_vol_tensor"
    V_CC_LAST = "last_cc_voltage"
    V_CC_LAST_AVG = "avg_last_cc_voltage"
    V_END = "end_voltage"
    V_PREV_END = "end_vol_prev"
    V_PREV_END_AVG = "avg_end_vol_prev"
    V_END_AVG = "avg_end_voltage"
    V_TENSOR = "vol_tensor"

    Q = "q_direct"
    Q_CC = "cc_capacities"
    Q_CC_TENSOR = "cc_cap_tensor"
    Q_CV = "cv_capacities"
    Q_CV_TENSOR = "cv_cap_tensor"
    Q_CC_LAST = "last_cc_capacity"
    Q_CV_LAST = "last_cv_capacity"

    I = "current"
    I_CC = "constant_current"
    I_CC_AVG = "avg_const_current"
    I_CV = "cv_current"
    I_CVS = "cv_currents"
    I_CV_TENSOR = "cv_current_tensor"
    I_END = "end_current"
    ...
    MASK_CC = "cc_masks"
    MASK_CC_TENSOR = "cc_mask_tensor"
    MASK_CV = "cv_masks"
    MASK_CV_TENSOR = "cv_mask_tensor"
