# Generated by Django 2.2.11 on 2020-06-10 16:17
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('charge_constant_rate_min', models.FloatField(blank=True, null=True)),
                ('charge_end_rate_min', models.FloatField(blank=True, null=True)),
                ('charge_end_rate_prev_min', models.FloatField(blank=True, null=True)),
                ('charge_end_voltage_min', models.FloatField(blank=True, null=True)),
                ('charge_end_voltage_prev_min', models.FloatField(blank=True, null=True)),
                ('charge_constant_rate_max', models.FloatField(blank=True, null=True)),
                ('charge_end_rate_max', models.FloatField(blank=True, null=True)),
                ('charge_end_rate_prev_max', models.FloatField(blank=True, null=True)),
                ('charge_end_voltage_max', models.FloatField(blank=True, null=True)),
                ('charge_end_voltage_prev_max', models.FloatField(blank=True, null=True)),
                ('discharge_constant_rate_min', models.FloatField(blank=True, null=True)),
                ('discharge_end_rate_min', models.FloatField(blank=True, null=True)),
                ('discharge_end_rate_prev_min', models.FloatField(blank=True, null=True)),
                ('discharge_end_voltage_min', models.FloatField(blank=True, null=True)),
                ('discharge_end_voltage_prev_min', models.FloatField(blank=True, null=True)),
                ('discharge_constant_rate_max', models.FloatField(blank=True, null=True)),
                ('discharge_end_rate_max', models.FloatField(blank=True, null=True)),
                ('discharge_end_rate_prev_max', models.FloatField(blank=True, null=True)),
                ('discharge_end_voltage_max', models.FloatField(blank=True, null=True)),
                ('discharge_end_voltage_prev_max', models.FloatField(blank=True, null=True)),
        ...
        migrations.AddField(
            model_name='dataset',
            name='wet_cells',
            field=models.ManyToManyField(to='cell_database.WetCell'),
        ),
        migrations.AddField(
